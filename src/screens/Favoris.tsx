...
function Favoris() {
    ...
    const { darkMode, setDarkMode, setFavoris, favoris } = useContext(ThemeContext);
        ...
        if (favoris.length > 0) {
            return pairs.map((pair, pairIndex) => (
                ...
                <View style={{ paddingBottom: 10}}>
                    <Search placeholder="Cherchez dans vos favoris" SearchFilter={(text) => setSearchText(text)} Value={searchText} />
                </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.content}>
                    ...
                    <View style={styles.categoriesContainer}>
                        {searchText.length > 0 ? renderSearchGrid() : renderCategoryGrid()}
                    </View>
